...
import { Building, Zap, Trash2, Droplet, Leaf, Plus, Minus } from "lucide-react"
...
const formSchema = z.object({
  ...
  floors: z.number().int().positive({ message: "Number of floors must be a positive integer." }),
  occupancy: z.number().int().nonnegative({ message: "Occupancy must be a non-negative integer." }),
  yearBuilt: z.number().int().positive().max(new Date().getFullYear(), { message: "Year built cannot be in the future." }),
  energySource: z.array(z.string()).nonempty({ message: "Select at least one energy source." }),
  averageMonthlyEnergy: z.number().nonnegative({ message: "Energy consumption must be a non-negative number." }),
  energyEfficiencyRating: z.string().optional(),
  wasteManagementSystem: z.string({ required_error: "Please select a waste management system." }),
  recyclingProgram: z.boolean(),
  waterConsumption: z.number().nonnegative({ message: "Water consumption must be a non-negative number." }),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Torre Sustentable" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Calle Ecológica 123, Ciudad Verde" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <div className="space-y-6">
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    <FormLabel className="text-base">Fuentes de Energía</FormLabel>
                    <FormDescription>
                      Seleccione todas las fuentes de energía utilizadas en el edificio.
                    </FormDescription>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    {["electricity", "natural-gas", "solar", "wind", "geothermal"].map((item) => (
                      <FormField
                        key={item}
                        control={form.control}
                        name="energySource"
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="municipal">Recolección Municipal</SelectItem>
                      <SelectItem value="private">Servicio Privado</SelectItem>
                      <SelectItem value="onsite">Tratamiento in situ</SelectItem>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Programa de Reciclaje</FormLabel>
                    <FormDescription>
          ...
          <div className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Sistema de Recolección de Agua de Lluvia</FormLabel>
                    <FormDescription>
                      ¿El edificio cuenta con un sistema de recolección de agua de lluvia?
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2 text-green-700">
              ...
              <h2 className="text-xl font-semibold">Características Sustentables</h2>
            </div>
            <FormField
              control={form.control}
              name="greenSpaces"
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  <div className="mb-4">
                    <FormLabel className="text-base">Características de Edificio Inteligente</FormLabel>
                    <FormDescription>
                      Seleccione todas las características de edificio inteligente presentes.
                    </FormDescription>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    {[
          ...
          <Button type="submit" className="bg-green-700 hover:bg-green-800">Registrar Edificio</Button>
        </form>
      </Form>
    </div>
  )
